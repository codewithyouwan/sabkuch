...
import { Eye, EyeOff, Lock, Mail, Shield, User, ChevronRight, Zap, FileText, Key, Bot, Sparkles, Layers, Grid3x3, ArrowRight } from 'lucide-react';
        ...
        <div className="w-full lg:w-2/5 max-w-md">
          <div className="bg-white/10 backdrop-blur-xl rounded-2xl p-8 shadow-2xl border border-white/20">
            ...
            <div className="hidden lg:block mb-8">
              <h2 className="text-2xl font-bold text-white mb-2">Join SabKuch</h2>
              <p className="text-gray-300">Create your account to access powerful tools</p>
            </div>
